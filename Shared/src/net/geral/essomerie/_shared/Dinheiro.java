...
public final class Dinheiro implements Serializable {
	...
	public static final String		SEPARADOR_DECIMAL_S		= String.valueOf(SEPARADOR_DECIMAL);
	public static final String		SEPARADOR_MILHARES_S	= String.valueOf(SEPARADOR_MILHARES);

	public static Dinheiro add(final Dinheiro d1, final Dinheiro d2, final Dinheiro... ds) {
	...
	public Dinheiro(final String s) {
		this(Double.parseDouble(s.replaceAll(" ", "").replace(SEPARADOR_MILHARES_S, "")
				.replace(SEPARADOR_DECIMAL_S, ".")));
	}
	...
	public String toString() {
		if (str == null) {
			...
			final StringBuilder sb = new StringBuilder(inteiro_len + pontos + 3 + (negativo ? 2 : 0));
			if (negativo) {
				sb.append("- ");
			}
