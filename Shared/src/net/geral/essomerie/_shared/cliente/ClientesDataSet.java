...
public class ClientesDataSet implements Serializable {
  ...
  // private final HashMap<Integer, Telephone[]> idcliente2telefones = null;
  ...
  // // }
  // // final HashMap<Integer, Address[]> map2 = new HashMap<Integer,
  // Address[]>(
  // // map.size());
  ...
  // final HashMap<Integer, ArrayList<Telephone>> map = new HashMap<Integer,
  // ArrayList<Telephone>>();
  ...
  // }
  // final HashMap<Integer, Telephone[]> map2 = new HashMap<Integer,
  // Telephone[]>(
  // map.size());
  // for (final Integer i : map.keySet()) {
