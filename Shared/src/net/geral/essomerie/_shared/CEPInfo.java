...
public class CEPInfo {
	...
	public static int toInteger(String cepString) throws DataCorruptedException {
		cepString = cepString.replaceAll("[^\\d]", "");
		if (cepString.length() != 8) throw new DataCorruptedException("Invalid CEP: " + cepString);
	...
	public CEPInfo(final int cep, final String uf, final String cidade, final String bairro, final String endereco) {
		this.cep = cep;
		this.uf = uf;
		this.cidade = cidade;
		this.bairro = bairro;
