...
public class ConferenciaTableModel extends StringDinheiroLancamentosTableModel {
	...
	private final DinheiroTableCellEditor	dinheiroSemDetalhesEditor	= new DinheiroTableCellEditor(false, false);
	...
	public TableCellEditor getCellEditor(final int row, final int column) {
		if ((column == 1) && (row != ConferenciaLancamentos.DINHEIRO)) { return dinheiroSemDetalhesEditor; }
	...
	public boolean isCellEditable(final int rowIndex, final int columnIndex) {
		...
		if (rowIndex >= ConferenciaLancamentos.LINHAS_FIXAS) { return true; }
		//nao pode
		return false;
	}
}
