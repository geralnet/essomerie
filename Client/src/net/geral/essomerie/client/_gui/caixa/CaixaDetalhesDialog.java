...
public class CaixaDetalhesDialog extends JDialog implements ItemListener,
  ...
  public CaixaDetalhesDialog() {
    ...
    cbMes.setModel(new DefaultComboBoxModel<String>(new String[] { "Janeiro",
    ...
    lblDiaSemana.setFont(lblDiaSemana.getFont().deriveFont(
    ...
    lblComputador.setFont(lblComputador.getFont().deriveFont(
    ...
    btnDia = new JButton("");
    btnDia.setIcon(new ImageIcon(CaixaDetalhesDialog.class
        .getResource("/res/img/sol.png")));
    btnDia.addActionListener(this);
    panelBotoes.add(btnDia);

    btnNoite = new JButton("");
    btnNoite.setIcon(new ImageIcon(CaixaDetalhesDialog.class
        .getResource("/res/img/lua.png")));
  ...
  public void actionPerformed(final ActionEvent e) {
    detalhes = new CaixaDetalhes(getDate(), (e.getSource() == btnDia),
        CRUtil.getComputador("NA"));
    setVisible(false);
  }
  ...
  private Calendar getDate() {
    ...
    c.clear();
    c.clear();
    c.set(tfAno.getValue(false), cbMes.getSelectedIndex(),
        tfDia.getValue(false));
    return c;
  }
