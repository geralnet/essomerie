...
public class SalaoTableModel extends BaseLancamentosTableModel {
	...
	private static final String[]			COLUNAS					= { "M", "P", "Consumo", "Serviço", "Repique",
			"Conta", "Pago", "C. Médio"							};
	private static final int[]				TAMANHOS				= { 30, 30, 0, 0, 0, 0, 0, 0 };
	private static final Class<?>[]			TIPOS					= { Integer.class, Integer.class, Dinheiro.class,
			Dinheiro.class, Dinheiro.class, Dinheiro.class, Dinheiro.class, Dinheiro.class };

	private final DinheiroTableCellEditor	dinheiroPositivoEditor	= new DinheiroTableCellEditor(false, false);
	private final DinheiroTableCellEditor	dinheiroNegativoEditor	= new DinheiroTableCellEditor(true, false);
	...
	public void setValueAt(final Object aValue, final int rowIndex, final int columnIndex) {
		switch (columnIndex) {
			...
			case 4:
				...
				break;
			default:
				throw new InvalidParameterException("R" + rowIndex + "C" + columnIndex + ": " + aValue);
		}
