...
public class CaixaImprimirFrame extends JFrame implements ActionListener {
	...
	public CaixaImprimirFrame(final CaixaDetalhes detalhes, final Lancamentos lancamentos) {
		...
		//final ___PrintPreviewPanel resumoPanel = new ___PrintPreviewPanel(resumo);
