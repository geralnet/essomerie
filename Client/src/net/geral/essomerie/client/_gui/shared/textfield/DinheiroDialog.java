...
public class DinheiroDialog extends JDialog implements ActionListener, KeyListener {
	private static final long			serialVersionUID	= 1L;
	private final JPanel				contentPanel		= new JPanel();
	private final IntegerTextField		txtNotas100Q;
	private final DinheiroTextField		txtNotas100V;
	private final IntegerTextField		txtNotas50Q;
	private final DinheiroTextField		txtNotas50V;
	private final IntegerTextField		txtNotas20Q;
	private final DinheiroTextField		txtNotas20V;
	private final IntegerTextField		txtNotas10Q;
	private final DinheiroTextField		txtNotas10V;
	private final IntegerTextField		txtNotas5Q;
	private final DinheiroTextField		txtNotas5V;
	private final IntegerTextField		txtNotas2Q;
	private final DinheiroTextField		txtNotas2V;
	private final IntegerTextField		txtMoedas100Q;
	private final DinheiroTextField		txtMoedas100V;
	private final IntegerTextField		txtMoedas50Q;
	private final DinheiroTextField		txtMoedas50V;
	private final IntegerTextField		txtMoedas25Q;
	private final DinheiroTextField		txtMoedas25V;
	private final IntegerTextField		txtMoedas10Q;
	private final DinheiroTextField		txtMoedas10V;
	private final IntegerTextField		txtMoedas5Q;
	private final DinheiroTextField		txtMoedas5V;
	private final IntegerTextField		txtMoedas1Q;
	private final DinheiroTextField		txtMoedas1V;
	private final DinheiroTextField		txtValesV;
	private final DinheiroTextField		txtChequesV;
	private final DinheiroTextField		txtCartoesV;
	private final DinheiroTextField		txtOutrosV;
	...
	private final DinheiroTextField[]	txtValores;
	private final JPanel				panelDetalhamento;
	private boolean						cancelado			= true;

	private final Dinheiro[]			emReais				= new Dinheiro[] { Dinheiro.NOTA_100, Dinheiro.NOTA_50,
			Dinheiro.NOTA_20, Dinheiro.NOTA_10, Dinheiro.NOTA_5, Dinheiro.NOTA_2, Dinheiro.MOEDA_100,
			Dinheiro.MOEDA_50, Dinheiro.MOEDA_25, Dinheiro.MOEDA_10, Dinheiro.MOEDA_5, Dinheiro.MOEDA_1 };
	...
	public DinheiroDialog(final DinheiroTextField ref, final String titulo) {
		setAlwaysOnTop(true);
		setModal(true);
		...
		txtNotas100V = new DinheiroTextField(false, false);
		...
		txtNotas50V = new DinheiroTextField(false, false);
		...
		txtNotas20V = new DinheiroTextField(false, false);
		...
		txtNotas10V = new DinheiroTextField(false, false);
		...
		txtNotas5V = new DinheiroTextField(false, false);
		...
		txtNotas2V = new DinheiroTextField(false, false);
		...
		txtMoedas100V = new DinheiroTextField(false, false);
		...
		txtMoedas50V = new DinheiroTextField(false, false);
		...
		txtMoedas25V = new DinheiroTextField(false, false);
		...
		txtMoedas10V = new DinheiroTextField(false, false);
		...
		txtMoedas5V = new DinheiroTextField(false, false);
		...
		txtMoedas1V = new DinheiroTextField(false, false);
		...
		txtValesV = new DinheiroTextField(false, false);
		...
		txtChequesV = new DinheiroTextField(false, false);
		...
		txtCartoesV = new DinheiroTextField(false, false);
		...
		txtOutrosV = new DinheiroTextField(false, false);
		...
		txtQuantidades = new IntegerTextField[] { txtNotas100Q, txtNotas50Q, txtNotas20Q, txtNotas10Q, txtNotas5Q,
				txtNotas2Q, txtMoedas100Q, txtMoedas50Q, txtMoedas25Q, txtMoedas10Q, txtMoedas5Q, txtMoedas1Q };

		txtValores = new DinheiroTextField[] { txtNotas100V, txtNotas50V, txtNotas20V, txtNotas10V, txtNotas5V,
				txtNotas2V, txtMoedas100V, txtMoedas50V, txtMoedas25V, txtMoedas10V, txtMoedas5V, txtMoedas1V };
	...
	private void ajustarTextFields() {
		for (int i = 0; i < emReais.length; i++) {
			txtValores[i].setMultiplo(emReais[i]);
		}
		...
		try {
			for (int i = 0; i < emReais.length; i++) {
				if (src == txtQuantidades[i]) {
					txtValores[i].setValue(new Dinheiro(txtQuantidades[i].getInteger() * emReais[i].getDouble()));
					return;
				}
				if (src == txtValores[i]) {
					txtQuantidades[i].setValue(new Integer((int)(txtValores[i].getValue(false).getDouble() / emReais[i]
							.getDouble())));
					return;
				}
			}
	...
	public Dinheiro getValor() throws NumberFormatException {
		//verificar por erros
		for (final Component c : panelDetalhamento.getComponents()) {
			if (c instanceof FormulaTextField<?>) {
				if (((FormulaTextField<?>)c).hasError()) { return null; }
			}
		}

		Dinheiro valor = Dinheiro.ZERO;
		for (final DinheiroTextField txtValore : txtValores) {
	...
	public void setValor(final Dinheiro dinheiro) {
