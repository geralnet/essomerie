...
public class BulletinBoardCache {
    ...
    public synchronized String getTitle(final int id) {
    ...
    public synchronized BulletinBoardTitle[] getTitles() {
	return titles.toArray(new BulletinBoardTitle[titles.size()]);
    }
	...
	if (entry == null) {
	    throw new IllegalArgumentException(
		    "bulletin board entry cannot be null.");
	}
